...
- **Collaborative Drawing Web App** — Multi-user whiteboard with sub-100ms canvas sync over Socket.IO, MongoDB session persistence, Dockerized. → [whitebored-deployed](https://whitebored-client.vercel.app)
